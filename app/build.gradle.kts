...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10300)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.3.0")
